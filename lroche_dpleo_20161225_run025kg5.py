...
lcurve_dpleo_data = open("dpleo_20161225_run025kg5.dat",'r').readlines()
...
for line in open("dpleo_20161225_run025kg5.dat"):
    li=line.strip()
...
dat = data_result
f = open('data_dpleo_20161225_run025kg5.txt', 'w')
...
#################################################################################
#Please change the input file
lcurve_dpleo_output = open("dpleo_20161225_run025kg5.out",'r').readlines()
...
for line in open("dpleo_20161225_run025kg5.out"):
    li=line.strip()
    if not li.startswith("#"):
...
out = output_result
f = open('output_dpleo_20161225_run025kg5.txt', 'w')
#for upper_result in upper_result:
...
res = residual_result
f = open('residual_dpleo_20161225_run025kg5.txt', 'w')
#for upper_result in upper_result:
...
#plot result:
InputFile_1 = "data_dpleo_20161225_run025kg5.txt"
Data_1   = np.genfromtxt(InputFile_1)

InputFile_2 = "output_dpleo_20161225_run025kg5.txt"
Data_2   = np.genfromtxt(InputFile_2)

InputFile_3 = "residual_dpleo_20161225_run025kg5.txt"
...
ax0.errorbar(MJD_time_1, Flux_1, yerr=Flux_err_1, fmt='o', markersize = 4, alpha = 0.25, color='red', label = 'data\_20161225\_run025kg5')

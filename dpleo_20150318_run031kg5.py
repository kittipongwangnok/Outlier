...
lcurve_dpleo_data = open("dpleo_20150318_run031kg5.dat",'r').readlines()
...
for line in open("dpleo_20150318_run031kg5.dat"):
    li=line.strip()
...
dat = data_result
f = open('data_dpleo_20150318_run031kg5.txt', 'w')
...
#################################################################################
#Please change the input file
lcurve_dpleo_output = open("dpleo_20150318_run031kg5.out",'r').readlines()
...
for line in open("dpleo_20150318_run031kg5.out"):
    li=line.strip()
    if not li.startswith("#"):
...
out = output_result
f = open('output_dpleo_20150318_run031kg5.txt', 'w')
#for upper_result in upper_result:
...
res = residual_result
f = open('residual_dpleo_20150318_run031kg5.txt', 'w')
#for upper_result in upper_result:
...
ax0.errorbar(MJD_time_1, Flux_1, yerr=Flux_err_1, fmt='o', markersize = 4, alpha = 0.25, color='red', label = 'data\_20150318\_run032kg5')
